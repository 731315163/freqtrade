...
from freqtrade.exchange.exchange import logger, timeframe_to_seconds
...
class ExchangeWS():
    ...
    def _schedule_while_true(self) -> None:
    ...
    async def schedule_ohlcv(self, pair: str, timeframe: str, candle_type: CandleType) -> None:
        """
